...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener, GoogleMap.OnPoiClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        LatLng sydney = new LatLng(37.94036, 112.48699);

        mMap = googleMap;

//        // Add a marker in Sydney and move the camera
        mMap.addMarker(new MarkerOptions().snippet("The most populous city in China.").position(sydney).title("Marker in TaiYuan").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
        ...
        googleMap.addMarker(new MarkerOptions().position(points.get(0)).title("开始"));
        googleMap.addMarker(new MarkerOptions().position(points.get(points.size() - 1)).title("结束"));
...
//        Toast.makeText(this, "MyLocation button clicked", Toast.LENGTH_SHORT).show();
    ...
    public void onMyLocationClick(@NonNull Location location) {
        ...
        Log.e("========", "onMyLocationClick: " + location.getLatitude() + "--" + location.getLongitude());
